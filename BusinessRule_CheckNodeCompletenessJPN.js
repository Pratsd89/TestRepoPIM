...
{
  "id" : "CheckNodeCompletenessJPN",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Check Node CompletenessForJPN",
  "description" : null,
  "scope" : "Global",
...
if(objType == "Style"){
	...
	if (node.isInState("wf_CCEnrichmentJapan", "NewCCEnrichState1") == true) {
	...
	if (node.isInState("wf_NewSKUEnrichmentJapan", "NewSKUEnrich1") == true){
