...
{
  "id" : "br_SEO_CrossContextImportJP",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "SEO Validate Cross-Context Import JP",
  "description" : null,
  "scope" : "Global",
...
if (context) {
	...
	logArray.push("\n<b>File is not allowed to be imported in the current widget.Please import the file in " + context + " " +"File Loading Import Widget</b>");
		...
		return "<b>SEO update rejected for WebCategory " + node.getValue("a_WebCategory_CID").getSimpleValue() + " due to the following reasons: </b>" + logArray; 
	}
