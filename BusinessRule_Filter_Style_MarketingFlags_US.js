...
{
  "id" : "Filter_Style_MarketingFlags_US",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Filter_Style_MarketingFlags_US",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
var temp = node;
if (temp != null) {
	var dataContainerObject1 = node.getDataContainerByTypeID('StyleMarketingFlag1').getDataContainerObject();
	var dataContainerObject2 = node.getDataContainerByTypeID('StyleMarketingFlag2').getDataContainerObject();
	var dataContainerObject3 = node.getDataContainerByTypeID('StyleMarketingFlag3').getDataContainerObject();
	var dataContainerObject4 = node.getDataContainerByTypeID('StyleMarketingFlag4').getDataContainerObject();
	var dataContainerObject5 = node.getDataContainerByTypeID('StyleMarketingFlag5').getDataContainerObject();
	var dataContainerObject6 = node.getDataContainerByTypeID('StyleMarketingFlag6').getDataContainerObject();
	var dataContainerObject7 = node.getDataContainerByTypeID('StyleMarketingFlag7').getDataContainerObject();
	var dataContainerObject8 = node.getDataContainerByTypeID('StyleMarketingFlag8').getDataContainerObject();
	var dataContainerObject9 = node.getDataContainerByTypeID('StyleMarketingFlag9').getDataContainerObject();
	var dataContainerObject10 = node.getDataContainerByTypeID('StyleMarketingFlag10').getDataContainerObject();
...
function filter(dataContainerObject) {
	...
	if (dataContainerObject != null) {
		...
		flag = dataContainerObject.getValue('a_style_marketing_flag').getSimpleValue();
