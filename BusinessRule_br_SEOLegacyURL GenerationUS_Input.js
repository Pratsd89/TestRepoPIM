...
{
  "id" : "br_SEOLegacyURL GenerationUS_Input",
  "type" : "BusinessAction",
  "setupGroups" : [ "SEO" ],
  "name" : "SEO Legacy URL Generation US Input",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
fw.write("Brand,Market,contest,ObjectType,ID,CID,Name,ParentName,CategoryName,CategoryStartDate,CategoryEndDate,WebCategoryHide,EN_US_NLU,EN_US_LegayPreviewURL,EN_US_NLU_PreviewURL,EN_US_Legay_LIVEURL,EN_US_NLU_LIVEURL\n");
...
function getDivisionDetails(divisiondObj, divContext,contextID) {
	...
	fw.write(brandNo + "," + market + "," +contextID+","+ objectTypeName + "," + divisionId + "," + divisionCID + ","+Name+","+parentName+","+divCtyName+","+ctyStartDate+","+ctyEndDate+","+categoryHide+","+categoryNLU + "," + legacyPreview +","+nluPreview +","+legacyLive+"," +nluLive+ "\n");
}
...
function getCategoryDetails(ctyObject, ctyContext,contextID) {
	...
	fw.write(catBrandNo + "," + market + "," +contextID+","+ objectTypeCty + "," + ctyId + "," + ctyCID + ","+Name+","+parentName+","+ctyCtyName+","+ctyStartDate+","+ctyEndDate+","+categoryHide+","+ ctyNLU + "," + legacyPreview + "," + nluPreview +","+legacyLive+"," +nluLive + "\n");
}
...
function getSubCategoryDetails(subCtyObject, subCtyContext,contextID) {
	...
	fw.write(subCtyBrandNo + "," + market + "," +contextID+ ","+ objectTypeSubCty + "," + subCtyid + "," + subCtyCID + ","+Name+","+parentName+","+subCtyName+","+ctyStartDate+","+ctyEndDate+","+categoryHide+","+subCtyNLU + "," + legacyPreview + "," + nluPreview +","+legacyLive+"," +nluLive+ "\n");
}
...
var emailBody = mailMethod.plainMessage("Please find "+ brandMailInput+ " NLU Preview URL's for "+ contextID);
