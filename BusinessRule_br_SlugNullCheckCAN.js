...
{
  "id" : "br_SlugNullCheckCAN",
  "type" : "BusinessAction",
  "setupGroups" : [ "SEO" ],
  "name" : "br_SlugNullCheckCAN",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
var emailSubject = mailMethod.subject("SlugNameCheck_CAN");
var emailBody = mailMethod.plainMessage("Slug Name Check CAN");
// set attachment 
var attachment = mailMethod.attachment();
var fromAsssest = attachment.fromAsset(asset);
var setAttachMentName = attachment.name("SlugNameCheck_CAN.csv");
attachment.attach();
//send email 
