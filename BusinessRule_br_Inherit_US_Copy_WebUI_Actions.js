...
{
  "id" : "br_Inherit_US_Copy_WebUI_Actions",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Inherit US Copy WebUI Actions",
  "description" : null,
  "scope" : "Global",
            ...
            inheritCopyMkts.forEach(function (mkt) {
                if (mkt.getValue() != "SA") {
                    if (mktDesignation.contains(mkt.getValue())) {
                        ...
                        mkt.deleteCurrent();
                        webUI.showAlert("WARNING:", "Inherit US Copy Option of " + mkt + " was removed, as this is not a valid market for the Style");
                    }
                }
            });
        }
