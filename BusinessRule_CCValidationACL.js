...
try{
	...
	//Changing to see approval status and replace it with lifecycle status as part of 2940/1802
	var status = node.getValue("a_CC_Life_Cycle_Status").getValue();
	if(status == "Approved" && (!(node.isInWorkflow("wf_CCEnrichment")))){
