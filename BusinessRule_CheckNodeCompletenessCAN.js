...
{
  "id" : "CheckNodeCompletenessCAN",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Check Node CompletenessForCAN",
  "description" : null,
  "scope" : "Global",
...
if(objType == "Style"){
	...
	if (node.isInState("wf_CCEnrichmentCanada", "NewCCEnrichState1") == true) {
	...
	if (node.isInState("wf_NewSKUEnrichmentCanada", "NewSKUEnrich1") == true){
