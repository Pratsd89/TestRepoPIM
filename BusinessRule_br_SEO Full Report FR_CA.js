...
{
  "id" : "br_SEO Full Report FR_CA",
  "type" : "BusinessAction",
  "setupGroups" : [ "SEO" ],
  "name" : "br_SEO Full Report FR_CA",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
fw.write("ID,CID,Brand,CategoryStartDate,CategoryEndDate,WebCategoryHide,ObjecType,FR_CA_NLU,FR_CA_Legay_LIVEURL,FR_CA_NLU_LIVEURL\n");
...
function generatePreviewNLULegacyURLDivision(brandInput, nluInput, cidInput, legacy, context) {
	...
	if (context == "EN_CA") {
		...
		var temp3 = "&locale=fr_CA&previewDate=2024-09-19%2016%3A14%3A00%20PDT";
	}
	if (legacy == 'LEGACY') {
		return temp + temp2 + cidInput + temp3;
	}
...
function getDivisionDetails(divisiondObj, divContext,contextID) {		//Division ID
	...
	var fr_CA_legacyLive = generatePreviewNLULegacyURLDivisionLIVE(brandNo, fr_CA_divslugNLU, divisionCID, "LEGACY", "FR_CA");
	var fr_CA_nluLive = generatePreviewNLULegacyURLDivisionLIVE(brandNo, fr_CA_divslugNLU, divisionCID, "PREVIEW", "FR_CA");
	...
	fw.write(divisionId + "," +divisionCID+ "," +brandNo+ "," +ctyStartDate+ "," +ctyEndDate+ "," +categoryHide+ ","+objectTypeName+ ","+fr_CA_divslugNLU + "," +fr_CA_legacyLive+"," +fr_CA_nluLive+ "\n");
...
function getCategoryDetails(ctyObject, ctyContext,contextID) {
   ...
   var fr_CA_ctySlugNLU = getContextSpecificValues(ctyObject, "a_Natural_Language_URL", "FR_CA");
	...
	var fr_CA_nluLive = generatePreviewNLULegacyURLCategory(catBrandNo, fr_CA_ctySlugNLU, ctyCID, "PREVIEW", "FR_CA");
	var en_CA_legacyLive = generatePreviewNLULegacyURLCategoryLIVE(catBrandNo, en_CA_ctySlugNLU, ctyCID, "LEGACY", "FR_CA");
	var fr_CA_legacyLive = generatePreviewNLULegacyURLCategoryLIVE(catBrandNo, fr_CA_ctySlugNLU, ctyCID, "LEGACY", "FR_CA");
	...
	fw.write(ctyId+ "," +ctyCID + "," +catBrandNo+","+ctyStartDate+","+ctyEndDate+","+categoryHide+ "," +objectTypeCty+ ","+fr_CA_ctySlugNLU + "," +fr_CA_legacyLive+"," +fr_CA_nluLive + "\n");
}//################################################################
//********** write Category details  ***********
//################################################################
function getSubCategoryDetails(subCtyObject, subCtyContext,contextID) {
	...
	var fr_CA_nluLive = generatePreviewNLULegacyURLSubCategoryLIVE(subCtyBrandNo, fr_CA_subCtySlugNLU, subCtyCID, subCtyCtyCID, "PREVIEW", "FR_CA");
	//var fr_CA_nluPreview = generatePreviewNLULegacyURLSubCategory(subCtyBrandNo, fr_CA_subCtySlugNLU, subCtyCID, subCtyCtyCID, "PREVIEW", "FR_CA");
	...
	var fr_CA_legacyLive = generatePreviewNLULegacyURLSubCategoryLIVE(subCtyBrandNo, fr_CA_subCtySlugNLU, subCtyCID, subCtyCtyCID, "LEGACY", "FR_CA");
	...
	fw.write(subCtyid + "," + subCtyCID + "," +subCtyBrandNo+ "," +ctyStartDate+","+ctyEndDate+","+categoryHide+ "," +objectTypeSubCty+ "," +fr_CA_subCtySlugNLU+ "," + fr_CA_legacyLive+"," +fr_CA_nluLive+ "\n");
