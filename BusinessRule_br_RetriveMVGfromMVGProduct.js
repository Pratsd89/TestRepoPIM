...
{
  "id" : "br_RetriveMVGfromMVGProduct",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "br_RetriveMVGfromMVGProduct",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
var MVGTemplateClassification = getMVGTemplateFromMVGProduct(node,manager);
//log.info(MVGTemplateClassification);
...
function getMVGTemplateFromMVGProduct(node,manager) 
{
