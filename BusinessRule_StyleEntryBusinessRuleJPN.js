...
{
  "id" : "StyleEntryBusinessRuleJPN",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "StyleEntryBusinessRuleJPN",
...
step.executeInContext('EN_JP', function (jpContextManager) {
	...
	var styleMarketDesignation = jpCurrentProduct.getValue('a_Style_Market_Designation').getSimpleValue();
	var translationStatus = jpCurrentProduct.getValue('a_Translation_Status').getSimpleValue();
	
	var translationUrgency = jpCurrentProduct.getValue('a_Translation_Urgency').setSimpleValue('1. Standard');
	...
	//if(styleMarketDesignation != 'US' && translationStatus!='Submitted' && translationStatus != 'Complete'){
 	if(translationStatus != 'Submitted' && translationStatus != 'Complete'){
		jpCurrentProduct.getValue('a_Translation_Status').setSimpleValue('Needed');
	}
});
...
/*===== business rule plugin definition =====
{
  ...
  "parameters" : [ {
    ...
    "id" : "stateFlowID",
    "type" : "java.lang.String",
    "value" : "wf_NewStyleEnrichmentJapan"
  } ],
  "pluginType" : "Operation"
}
*/
