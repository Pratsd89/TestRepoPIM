...
{
  "id" : "br_ASLR_CC_Trigger_US_Market",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "ASLR CC Trigger For US Market",
  "description" : null,
  "scope" : "Global",
...
else if ((marketCode != null && context == "EN_US" && brandNum=="BR"&& webProductType != "Dropship") || (marketCode != null && context == "EN_US" && brandNum=="BRFS"&& webProductType != "Dropship" ) || (marketCode != null && context == "EN_US" && brandNum=="AT"&& webProductType != "Dropship" ))  {
	if (marketCode.indexOf('US') != -1) {
