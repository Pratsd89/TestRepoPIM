...
{
  "id" : "PreviewURLGeneration",
  "type" : "BusinessAction",
  "setupGroups" : [ "TestBusinessRules" ],
  "name" : "PreviewURLGeneration",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
var filePath = "/opt/stibo/SEO-PIM-Report_For_Legacy_NLU.csv";
	...
	fw.write("ObjectType,ObjectID,ObjectCID,NaturalLanguageURL,PreviewLegacyURL,a,b,c\n");
...
{		//Division ID
			...
			var brandNo =getAttributeValue(divisiondObj,"a_Brand_Number");
			 ...
			 fw.write(objectTypeName+","+"divisionId+","+divisionCID+","+divisionSlug+","+categoryNLU+","+en_CA_divslugNLU +","+fr_CA_divslugNLU+","+brandNo"+"\n");
	...
	{	
           ...
           fw.write(objectTypeCty+","+"ctyId+","+ctyCID+","+ctySlug+","+ctyNLU+","+en_CA_ctySlugNLU +","+fr_CA_divslugNLU+","+brandNo"+"\n");
	...
	{			
          ...
          fw.write(objectTypeSubCty+","+"subCtyid+","+subCtyCID+","+subCtySlug+","+subCtyNLU+","+en_CA_subCtySlugNLU +","+fr_CA_divslugNLU+","+brandNo"+"\n");
