...
*/
exports.operation0 = function (step,AV1,ShotreqRef,mail,AV2,AV3,AV4,AV5,AV6,AV7,AV8,AV9,AV10,AV11,P01,XternalAsset,lib) {

// Set brand folder
//var brandFolder = step.getProductHome().getProductByID("525719ff-7c08-49bf-9150-fee384eba1cf"); //
//
//var divisionFolders = brandFolder.getChildren().iterator();
//while (divisionFolders.hasNext()) {
var divisionFolder = step.getProductHome().getProductByID("fd388d02-88d8-445c-b710-e68b316eda7f");
//		if(divisionFolder.getID() == "fd388d02-88d8-445c-b710-e68b316eda7f"){
//			continue;
//		}
