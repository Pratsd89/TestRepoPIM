...
{
  "id" : "br_Copying_Image_From_CC_To_Style_CAN",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Copying Image Ref From CC To Style CAN Conditon",
  "description" : null,
  "scope" : "Global",
...
if(sortOrderArray.length != 0){
	...
	if(!isCCSortOrderPresent){
		...
		node.getValue('a_error_message').setSimpleValue('There is no CC with Valid Market Designation Value i.e., CAN in this case.');
		return 'There is no CC with Valid Market Designation Value i.e., CAN in this case.';
