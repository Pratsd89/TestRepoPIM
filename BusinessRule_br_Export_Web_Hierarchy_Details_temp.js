...
{
  "id" : "br_Export_Web_Hierarchy_Details_temp",
  "type" : "BusinessAction",
  "setupGroups" : [ "SEO" ],
  "name" : "br_Export_Web_Hierarchy_Details_temp",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
{		//Division ID
			...
			log.info("seoMetadataDescription, "+seoMetadataDescription+","+divisiondObj+","+divContext)
...
function mainMethod(context)
{
	...
	var emailIDTO  = mailMethod.addTo("natalie_bargas@gap.com;merry_touch@gap.com;janette_fuentes@gap.com;alexander_bocknek@gap.com;jagadish_beejapu@gap.com;sai_preethi_mandipalli@gap.com;sri_indu_dekkapati@gap.com;rohith_kasula@gap.com;aswathi_naranath@gap.com;priyadarshini_sahoo@gap.com;HQ-SEO-DG@gap.com;venugopal_nandimandalam@gap.com");
