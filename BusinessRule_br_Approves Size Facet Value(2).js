...
{
  "id" : "br_Approves Size Facet Value(2)",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "br_Approves Size Facet Value(2)",
  "description" : null,
  "scope" : "Global",
...
*/
exports.operation0 = function (log,node,stepManager) {
...
else
{
	...
	for(i=0;i<referencedBy.length;i++)
	{
		...
		if(x=="Dim1" || x=="Dim2")
		{
			...
			{
				log.info(classSKU);
				var uniqueIDList = new java.util.set();
