...
{
  "id" : "br_CustomerServiceCategory_Approval_Code",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Customer Service Category Approval Code",
  "description" : null,
  "scope" : "Global",
...
var categoryEndDate = node.getValue('a_Customer_Service_Category_End_Date').getSimpleValue();
...
if(webCategoryCID == null || webCategoryCID == '' || categoryDisplayType == null || categoryDisplayType == '' || categoryDescription == null || categoryDescription == '' || categoryStartDate == null || categoryStartDate == '' || categoryEndDate == null || categoryEndDate == '')
{
	throw 'Please fill all the mandatory fields and try again.';
}
