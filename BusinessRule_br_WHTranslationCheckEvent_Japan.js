...
{
  "id" : "br_WHTranslationCheckEvent_Japan",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Check Translation Event - WH - Japan",
  "description" : null,
  "scope" : "Global",
...
// PPIM-10282 - Introducing OIEP event filter for Web Hierarchy Translation - Japan 
...
if (brandNumber == null ) {
	...
	if (currentEvent.getID() == translationEvent.getID() && markets.contains("JP")) {
		var time = new java.util.Date();
		var iso = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		step.executeInContext('EN_JP', function (jpContextManager) {
			var jpCurrentWH = jpContextManager.getClassificationHome().getClassificationByID(node.getID());
			jpCurrentWH.getValue("a_File_XTM_TimeStamp").setSimpleValue(iso.format(time));
		})
		return true;
	}
	else
