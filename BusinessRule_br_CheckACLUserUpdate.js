...
{
  "id" : "br_CheckACLUserUpdate",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Check ACL User on Update",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
	...
	if (lastModifiedUser.toUpperCase() == "STIBOACLUSER"){
		...
		if(result == true){
			step.executeInContext('EN_US',function(usContextManager){
				...
				if(usCurrentProduct.getValue("a_ACL_Market_Designation").getSimpleValue() == "US" && usCurrentProduct.getValue("a_ACL_Market_Designation").isInherited() == false){
					result = true;
					}
					else{
						result = false;
