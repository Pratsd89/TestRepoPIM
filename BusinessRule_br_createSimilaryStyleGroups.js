...
{
  "id" : "br_createSimilaryStyleGroups",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Create Similary Style Groups",
                    ...
                    if (primaryStylePresent) {
                        if (styleAlreadyReferencedFlag == false) {
                            ...
                            if (productGroupingDivisionObj != null) {
                                ...
                                newDuplicateStyleGroup.getValue("a_Message_Optional").setSimpleValue("DELETING");
								if(market == "US"){
									market = "US<multisep/>CAN";
								}
								newDuplicateStyleGroup.getValue("a_SuperPDP_Market").setSimpleValue(market);
