...
{
  "id" : "br_SEOLegacyURLGenerationCA_Input",
  "type" : "BusinessAction",
  "setupGroups" : [ "SEO" ],
  "name" : "(DEL) SEO Legacy URL Generation CA Input",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
*/
exports.operation0 = function (node,stepManager,mail,LIB_BRFS,SEOInputLibrary) {
...
function getDivisionDetails(divisiondObj, divContext) {		//Division ID
	...
	fw.write(brandNo + "," + market + "," + objectTypeName + "," + divisionId + "," + divisionCID + ","+Name+","+parentName+","+divCtyName+","+ctyStartDate+","+ctyEndDate+","+categoryHide+","+en_CA_divslugNLU + "," + en_CA_legacyPreview + "," + en_CA_nluPreview + ","+frenchName+","+frenchParentName+","+fr_CA_divCtyName+","+fr_CA_divslugNLU + "," + fr_CA_legacyPreview + "," + fr_CA_nluPreview + "\n");
...
function getCategoryDetails(ctyObject, ctyContext) {
	...
	fw.write(catBrandNo + "," + market + "," + objectTypeCty + "," + ctyId + "," + ctyCID + ","+Name+","+parentName+","+ctyCtyName+","+ctyStartDate+","+ctyEndDate+","+categoryHide+","+ en_CA_ctySlugNLU + "," + en_CA_legacyPreview + "," + en_CA_nluPreview + ","+frenchName+","+frenchParentName+","+frenchCtyCtyName+","+fr_CA_ctySlugNLU+","+fr_CA_legacyPreview + "," + fr_CA_nluPreview + "\n");
...
function getSubCategoryDetails(subCtyObject, subCtyContext) {
	...
	fw.write(subCtyBrandNo + "," + market + "," + objectTypeSubCty + "," + subCtyid + "," + subCtyCID + ","+Name+","+parentName+","+subCtyName+","+ctyStartDate+","+ctyEndDate+","+categoryHide+","+en_CA_subCtySlugNLU + "," + en_CA_legacyPreview + "," + en_CA_nluPreview + ","+frenchName+","+frenchParentName+","+fr_CA_subCtyName+","+fr_CA_subCtySlugNLU + "," + fr_CA_legacyPreview + "," + fr_CA_nluPreview + "\n");
}
