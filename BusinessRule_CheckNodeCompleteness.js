...
{
  "id" : "CheckNodeCompleteness",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Check Node Completeness",
  "description" : null,
  "scope" : "Global",
...
if(objType == "Style"){
	...
	if (node.isInState("wf_CCEnrichment", "NewCCEnrichState1") == true) {
	...
	if (node.isInState("wf_NewSKUEnrichment", "NewSKUEnrich1") == true){
