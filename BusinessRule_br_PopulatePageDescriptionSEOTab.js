...
{
  "id" : "br_PopulatePageDescriptionSEOTab",
  "type" : "BusinessAction",
  "setupGroups" : [ "SEO" ],
  "name" : "Populate Page Description SEO Tab",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
if (objectType == "WebDivision" || objectType == "WebCategory" || objectType == "WebSubCategory") {
        ...
        var currentPageTitle = node.getValue("a_SEO_Page_Title").getSimpleValue();
    	   ...
    	   if (currentPageTitle != oldPageTitle){
    	   	  ...
    	   	  var oldPageDesc = SEO.generatePageDescriptionBasedOnInput(step,node,oldPageTitle);
    	   	   log.info(currentPageDesc);
    	        log.info("oldPageDesc"+oldPageDesc);
    	   	  if (oldPageDesc == currentPageDesc){
    	   	  	 SEO.generatePageDescription(step,node);
    	   	  }
    	   	  node.getValue("a_Old_SEO_Page_Title").setSimpleValue(currentPageTitle);
    	   }
    }
