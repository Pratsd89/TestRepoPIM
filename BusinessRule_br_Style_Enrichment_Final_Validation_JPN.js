...
{
  "id" : "br_Style_Enrichment_Final_Validation_JPN",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Style Enrichment Final Validation JPN",
  "description" : null,
  "scope" : "Global",
...
/*===== business rule plugin definition =====
{
  ...
  "parameters" : [ {
    ...
    "value" : "br_CheckCurrentContextForJPNWorkflow"
  }, {
    ...
    if (!isErrorOccurred) {
        ...
        if (CCList.size() > 0) {
                    ...
                    if (marketDesignation.contains(mkt) == true) {
                        if (lifeCycleStatus != null) {
                            if (lifeCycleStatus == "Waiting for Style Approval" || lifeCycleStatus == "Approved") {
                                ...
                                translatedNameCheck = compCheck.checkCCNameAndColorInContext(cc, MANAGER, "JA_JP");
            ...
            if (ccWaitingForStyleApproval == false) {
                ...
                //PPIM-12637
                errorMsg = 'There is no Ready for Approval CC with a translated name in JA_JP under this Style.';
                isErrorOccurred = true;
            }
...
/*===== business rule plugin definition =====
{
  ...
  "parameters" : [ {
    "id" : "ReferencedBC",
    "type" : "com.stibo.core.domain.businessrule.BusinessCondition",
    "value" : "br_Copying_Image_From_CC_To_Style_JPN"
  }, {
    "id" : "ValueWhenReferencedIsNA",
    "type" : "com.stibo.util.basictypes.TrueFalseParameter",
    "value" : "false"
...
/*===== business rule plugin definition =====
{
  ...
  "parameters" : [ {
    "id" : "ReferencedBC",
    "type" : "com.stibo.core.domain.businessrule.BusinessCondition",
    "value" : "StyleSizeModelApprovalJPN"
  }, {
    "id" : "ValueWhenReferencedIsNA",
    "type" : "com.stibo.util.basictypes.TrueFalseParameter",
    "value" : "false"
...
if(CCchildren.size() != 0) {
	for(var i=0; i<CCchildren.size(); i++) {
		...
		if (child.isInState("wf_CCEnrichmentJapan", "NewCCEnrich_Final") || lifeCycleStatus == "Approved") {
