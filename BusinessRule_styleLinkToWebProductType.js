...
{
  "id" : "styleLinkToWebProductType",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "styleLinkToWebProductType",
  "description" : null,
  "scope" : "Global",
	...
	if (prodLinks){
		...
		while (prodLinksIter.hasNext()){
			...
			if(eachLink.getLinkType().getID() == "StyleToWebProductTypeRef"){
				...
				if(classId != existingWPT){
					eachLink.delete();   //Delete existing WPT link to Style when a new WPT is assigned- PPIM-10676
				}
			}
		}
	}
