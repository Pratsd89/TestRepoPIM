...
{
  "id" : "CA Mkt Flag Trigger Style event DGL",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "CA Marketing Flag Trigger Style event DGL",
...
/*===== business rule plugin definition =====
{
  ...
  "binds" : [ {
    ...
    "value" : "step://OutBoundIntegrationEndpoint?id=PublishMFStyleToDGL_Main_EN_CA",
    "description" : null
  }, {
