...
{
  "id" : "br_EN_CA_MVGReportBulkUpdate",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "br_EN_CA_MVGReportBulkUpdate",
  "description" : null,
  "scope" : "Global",
...
/*===== business rule plugin definition =====
{
  ...
  "binds" : [ {
    ...
    "alias" : "OIEP_MVGReviewProblemGroupStyle_EN_CA",
    "parameterClass" : "null",
    "value" : null,
    "description" : null
  }, {
...
*/
exports.operation0 = function (node,MultiVariant_Group_Reference,OIEP_MVGReviewProblemGroupStyle_EN_CA,qh,manager) {
...
var refList = node.queryReferences(MultiVariant_Group_Reference).asList(1000).toArray();
 for (var k in refList) {
	...
	OIEP_MVGReviewProblemGroupStyle_EN_CA.republish(style);
 }
}