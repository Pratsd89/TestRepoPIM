...
{
  "id" : "br_temp_Delete_Badges",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Delete Expired Badges(2)",
  "description" : null,
  "scope" : "Global",
...
var badgingDataContainerUS5 = node.getDataContainerByTypeID('BadgesUS5');
...
//var dataContainerArray = [badgingDataContainerUS1, badgingDataContainerUS2, badgingDataContainerUS3, badgingDataContainerUS4, badgingDataContainerUS5, badgingDataContainerUS6, badgingDataContainerUS7, badgingDataContainerUS8, badgingDataContainerUS9, badgingDataContainerUS10, badgingDataContainerCA1, badgingDataContainerCA2, badgingDataContainerCA3, badgingDataContainerCA4, badgingDataContainerCA5, badgingDataContainerCA6, badgingDataContainerCA7, badgingDataContainerCA8, badgingDataContainerCA9, badgingDataContainerCA10];
var dataContainerArray = [badgingDataContainerCA1, badgingDataContainerCA2, badgingDataContainerCA3, badgingDataContainerCA4, badgingDataContainerCA5, badgingDataContainerCA6, badgingDataContainerCA7, badgingDataContainerCA8, badgingDataContainerCA9, badgingDataContainerCA10];
...
for (var i = 0; i < dataContainerArray.length; i++) {
    ...
    for (var j = 0; j < dataContainers.length; j++) {
        ...
        if (singleDataContainer != null) {
            ...
            var value = singleDataContainer.getValue('a_badge_GAP').getSimpleValue();
            if (value != null && value =="New (Dynamic)") {
                singleDataContainer.getValue('a_badge_end_date').setSimpleValue("2024-01-01");
