...
{
  "id" : "br_PopulateStateExitTimeStamp_forEntity",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "br_PopulateStateExitTimeStamp_forEntity",
  "description" : null,
  "scope" : "Global",
...
var dataContainer = node.getDataContainerByTypeID('WF_StateTransitionEntityDataContainer').getDataContainers().toArray();
