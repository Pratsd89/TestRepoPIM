...
*/
exports.operation0 = function (node,stepManager,CCToShotRequestRef,shotRequestToExternalAssetRef,LKT,compCheck) {
/*
...
if (!node.isInState(wfID, "NewCCEnrich_Photo3") && !node.isInState(wfID, "NewCCEnrich_Final")) {
  return ("This CC " + node.getName() + " and Photos are not eligible for approval at this time");
}
