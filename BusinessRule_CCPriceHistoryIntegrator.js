...
{
  "id" : "CCPriceHistoryIntegrator",
  "type" : "BusinessFunction",
  "setupGroups" : [ "Functions" ],
  "name" : "CC Price History Integrator",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
if(objectType == 'CustomerChoice')
	objectType = 'CC'
if(ccId==null || brandNumber==null || channelNumber==null || marketNumber==null)
	 throw new Error("All the Mandatory values :: CC Number,Brand Number, Channel Number and Market Number to view the products.")
...
var Url="https://stibo-ui.aks.stage.azeus.gaptech.com/price-history/"+ccId+"/"+brandNumber+"/"+marketNumber+"/"+channelNumber + "/" + objectType;
