...
/*===== business rule plugin definition =====
{
  ...
  "binds" : [ {
    ...
    "value" : "step://eventprocessor?id=setMaintLastUpdateDate",
    "description" : null
  }, {
...
*/
exports.operation0 = function (node,log,stepManager,updateEVP,SKUDGL_OutboundUSDEvent,SKUDGL_OutboundCADEvent,SKUDGL_OutboundUS,SKUDGL_OutboundCA) {
log.info("BR br_SetMainLastUpdateForSizeFacetCategory");
var pWriter = new java.io.PrintWriter("/upload/sugu/sizeFacetCatSKUs.csv");
pWriter.println("Size Facet Value, Dim, Size Code, SKU");
                ...
                if (classSKU) {
                    ...
                    while (chIter11.hasNext()) {
						...
						if(uniqueIDList.contains(obj.getID()) == false)
						{
							...
							pWriter.println(curSFV.getID() + " - " + curSFV.getName() + "," +
										curDim.getID() + " - " + curDim.getName() + "," +
										scode.getID() + " - " + scode.getName() + "," +
