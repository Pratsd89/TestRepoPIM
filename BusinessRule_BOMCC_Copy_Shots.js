...
if (currentContext != "FR_CA" && currentContext != "JA_JP") {
    ...
    if (objectType == "CustomerChoice") {
        ...
        /*if (aclMarket == currentMarket && mktDsg.contains("JPN")) {
            ...
            step.executeInContext("EN_JP", function (contextManager) {
                ...
                for (var i = 0; i < refs.size(); i++) {
                    ...
                    //if (shared.contains("US") && (!(shared.contains(currentMarket)))) {
                    if (shared != null && shared.contains("JPN") && (!(shared.contains(currentMarket)))) {
        ...
        /*if (aclMarket == currentMarket && mktDsg.contains("CAN")) {
            ...
            step.executeInContext("EN_CA", function (contextManager) {
                ...
                for (var i = 0; i < refs.size(); i++) {
                    ...
                    //if (shared.contains("US") && (!(shared.contains(currentMarket)))) {
                    if (shared != null && shared.contains("CAN") && (!(shared.contains(currentMarket)))) {
            ...
            for (var i = 0; i < BOM_CCrefs.size(); i++) {
                ...
                if (ref_BOMcc) {
                    ...
                    step.executeInContext("EN_US", function (contextManager) {
                        ...
                        var enSearchColour = enCurrentProduct.getValue("a_Search_Color_Calc").getSimpleValue();
                        ...
                        for (var i = 0; i < refs.size(); i++) {
                            ...
                            if (shared.contains("US") && (!(shared.contains("SA"))) && shotStatus != "Draft" && shotStatus != "Cancelled" && shotStatus != "Rejected") {
                                ...
                                step.executeInContext("EN_SA", function (otherContextManager) {
                                    ...
                                    if (saSearchColour == null && enSearchColour != null){
                                    	saCurrentProduct.getValue("a_Override_Search_Color").setSimpleValue(enSearchColour);
                                    }
                                });
                            }
                        }
