...
{
  "id" : "br_checkTranslationEventJapan",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Check Translation Event - Japan",
  "description" : null,
  "scope" : "Global",
...
*/
// if event = Translation && marketDesignation = JPN, return true, else return false

var marketDesignation = node.getValue("a_Style_Market_Designation").getSimpleValue();
