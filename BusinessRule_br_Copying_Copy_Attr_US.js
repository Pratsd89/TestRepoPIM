...
{
  "id" : "br_Copying_Copy_Attr_US",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "(DEP) Copying Copy Attributes From US",
  "description" : null,
  "scope" : "Global",
 ...
 */
 ...
 if(marketCode != null && !(marketCode.indexOf("US") < 0) && !(marketCode.indexOf("CAN") < 0) && replicateEngCopy == 'Yes'){
...
if(marketCode != null && !(marketCode.indexOf("US") < 0) && !(marketCode.indexOf("JPN") < 0) && replicateEngCopy == 'Yes'){
      stepManager.executeInContext('EN_US',function(enContextManager) {	
		var enCurrentProduct = enContextManager.getProductHome().getProductByID(node.getID());	
