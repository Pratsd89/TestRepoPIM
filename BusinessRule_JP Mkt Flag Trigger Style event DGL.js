...
{
  "id" : "JP Mkt Flag Trigger Style event DGL",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "JP Mkt Flag Trigger Style event DGL",
...
/*===== business rule plugin definition =====
{
  ...
  "binds" : [ {
    ...
    "value" : "step://OutBoundIntegrationEndpoint?id=PublishMFStyleToDGL_Main_EN_JP",
    "description" : null
  }, {
