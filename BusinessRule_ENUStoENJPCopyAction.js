...
{
  "id" : "ENUStoENJPCopyAction",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "(DEP) ENUStoENJPCopyAction",
  "description" : "This BR will allow Style to get its copy attributes replicated from ENUS to ENJP after copy status is complete",
  "scope" : "Global",
...
//PPIM-7628 : This BR is created as part of JP Market changes 
