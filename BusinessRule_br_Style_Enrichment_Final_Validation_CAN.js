...
{
  "id" : "br_Style_Enrichment_Final_Validation_CAN",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Style Enrichment Final Validation CAN",
  "description" : null,
  "scope" : "Global",
...
/*===== business rule plugin definition =====
{
  ...
  "parameters" : [ {
    ...
    "value" : "br_CheckCurrentContextForCANWorkflow"
  }, {
...
/*
    ...
    This rule no longer check Product to Classification links and is now context agnostic
 */
...
if (Style_Start_Date != null) {
    if (Style_Start_Date > final_date || Style_Start_Date == final_date) {
        ...
        //LOG.info(NODE.getValue("a_New_Style").getSimpleValue());
    } else {
...
if (marketCodes != null) {
    if (marketCodes.contains(mkt) == true) {
        ...
        if (isErrorOccurred == false && mkt != 'US') {
            if (lastModifiedUser.toUpperCase() != "STIBOCATALOGSYNCUSER") {
                if (!(translationStatus == 'Complete')) {
                    errorMsg = "Style tranlsation status are not complete contains " + mkt + " market and Translation Request Status is not Complete.";
                    isErrorOccurred = true;
                }
            } else {
...
if (!isErrorOccurred) {
    ...
    if (CCList.size() > 0) {
                ...
                if (marketDesignation.contains(mkt) == true) {
                    if (lifeCycleStatus != null) {
                        if (lifeCycleStatus == "Waiting for Style Approval" || lifeCycleStatus == "Approved") {
                            ...
                            translatedNameCheck = compCheck.checkCCNameAndColorInContext(cc, MANAGER, "FR_CA");
                            skuDimCheck = compCheck.checkSKUDimensionForCC(cc, MANAGER);
                            if (translatedNameCheck == true && skuDimCheck == true) {
                                break;
                            }
                        }
                    }
        ...
        else if (ccWaitingForStyleApproval == true && translatedNameCheck != true) {
            //PPIM-12637
            errorMsg = 'There is no Ready for Approval CC with a translated name in FR_CA under this Style.';
            isErrorOccurred = true;
        }
...
/*===== business rule plugin definition =====
{
  ...
  "parameters" : [ {
    "id" : "ReferencedBC",
    "type" : "com.stibo.core.domain.businessrule.BusinessCondition",
    "value" : "br_Copying_Image_From_CC_To_Style_CAN"
  }, {
    "id" : "ValueWhenReferencedIsNA",
    "type" : "com.stibo.util.basictypes.TrueFalseParameter",
    "value" : "false"
...
/*===== business rule plugin definition =====
{
  ...
  "parameters" : [ {
    "id" : "ReferencedBC",
    "type" : "com.stibo.core.domain.businessrule.BusinessCondition",
    "value" : "StyleSizeModelApprovalCAN"
  }, {
    "id" : "ValueWhenReferencedIsNA",
    "type" : "com.stibo.util.basictypes.TrueFalseParameter",
    "value" : "false"
...
if(CCchildren.size() != 0) {
	for(var i=0; i<CCchildren.size(); i++) {
		...
		if (child.isInState("wf_CCEnrichmentCanada", "NewCCEnrich_Final") || lifeCycleStatus == "Approved") {
