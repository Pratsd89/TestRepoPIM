...
{
  "id" : "Stibo_TC_GAPNC622_ApprovalCode",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Web Hierarchy Approval Code(2)",
  "description" : null,
  "scope" : "Global",
...
if(categoryDisplayType == 'Standard: Core')
{
    ...
    if(oneProductExistFlag == false)
    {
        ...
        portal.showAlert("Warning", "Warning : For Category Display Type Standard: Core, please ensure there are products (Style/CC) are assigned to it. In case of missing product list, the Web Category/ Web Sub Category will not display in Site");
    }
}
