...
{
  "id" : "StyleSizeModelApprovalJPN",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "StyleSizeModelApprovalJPN",
  "description" : null,
  "scope" : "Global",
			...
			if (CC_ID != null) {
				...
				if (refs1.size() != 0 && lifeCycleStatus != "Draft" && lifeCycleStatus != "" && lifeCycleStatus != null) {
					for (var j = 0; j < refs1.size(); j++) {
						...
						if (refs1.get(j).getValue('a_Market_Designation').getSimpleValue().indexOf("JPN") >= 0 && isSkuActive == "true" && SKU_Status != "Draft" && SKU_Status != "" && SKU_Status != null ) {
