...
*/
exports.operation9 = function (node,UI,ag,step) {
...
if (categoryDescription != null) {
  ...
  if (objectType == "WebCategory" || objectType == "WebSubCategory") {
    ...
    if (sum == 1) {
      ...
      OtherTags = OtherTags.filter(function(tag) {
    ...
    if (validTags) {
      ...
      UI.showAlert("ERROR", "Invalid Tag Configuration", "Please fill out additional product tags for Autopop to run as these tag conditions will cause a very large assortment to be created");
...
*/
exports.operation14 = function (node) {

if(node.getValue("a_Is_Revived").getSimpleValue()!=null && node.getValue("a_Is_Revived").getSimpleValue()=="Yes"){
...
/*===== business rule plugin definition =====
{
  ...
  "parameters" : [ {
    "id" : "ReferencedBA",
    "type" : "com.stibo.core.domain.businessrule.BusinessAction",
    "value" : "br_QuickAdd_Default_Value"
  } ],
  "pluginType" : "Operation"
}
*/
