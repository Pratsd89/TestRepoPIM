...
{
  "id" : "br_Style_Enrichment_Final_Validation",
  "type" : "BusinessCondition",
  "setupGroups" : [ "Conditions" ],
  "name" : "Style Enrichment Final Validation",
  "description" : null,
  "scope" : "Global",
...
/*===== business rule plugin definition =====
{
  ...
  "parameters" : [ {
    ...
    "value" : "br_CheckCurrentContextForUSWorkflow"
  }, {
...
/*===== business rule plugin definition =====
{
  ...
  "parameters" : [ {
    "id" : "ReferencedBC",
    "type" : "com.stibo.core.domain.businessrule.BusinessCondition",
    "value" : "br_Copying_Image_From_CC_To_Style"
  }, {
    "id" : "ValueWhenReferencedIsNA",
    "type" : "com.stibo.util.basictypes.TrueFalseParameter",
    "value" : "false"
...
if(CCchildren.size() != 0) {
	for(var i=0; i<CCchildren.size(); i++) {
		...
		if (child.isInState("wf_CCEnrichment","NewCCEnrich_Final") || lifeCycleStatus == "Approved") {
