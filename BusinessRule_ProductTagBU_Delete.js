...
{
  "id" : "ProductTagBU_Delete",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Product Tag BU - Delete",
  "description" : null,
  "scope" : "Global",
...
/*===== business rule plugin definition =====
{
  ...
  "binds" : [ {
    ...
    "contract" : "AttributeValidatedContextParameterStringBinding",
    "alias" : "sweaterWeightTag",
    "parameterClass" : "com.stibo.core.domain.businessrule.attributecontextparameter.AttributeValidatedContextParameter",
    "value" : "<AttributeValidatedContextParameter>\n  <Parameters>\n    <Parameter ID=\"Attribute\" Type=\"java.lang.String\">a_Sweater_Weight_Tag_Inherit</Parameter>\n    <Parameter ID=\"ID\" Type=\"java.lang.String\">sweaterWeightTagVal</Parameter>\n  </Parameters>\n</AttributeValidatedContextParameter>",
    "description" : null
  }, {
    "contract" : "AttributeValidatedContextParameterStringBinding",
    "alias" : "coverageTag",
...
*/
exports.operation0 = function (departmentTag,productTypeTag,categoryGroupTag,styleTag,boutiqueTag,activityTag,brandTag,collarTag,collectionTag,detailsFeaturesTag,fabricMaterialTag,fitTag,legShapeTag,lengthTag,necklineTag,occasionTag,panelTypeTag,performanceTag,pregnancyStageTag,riseTag,sleeveLengthTag,supportTypeTag,sustainabilityTag,warmthRatingTag,washTag,log,manager,categoryTag,packageQuantityTag,jewelryMaterialTag,web,stretchTag,typeTag,destructionTag,sweaterWeightTag,coverageTag,sleeveTypeTag,popularSearchesTag,braTypeTag,inseamTag,compressionLevelTag,teamTag,closureTypeTag,printsTag,footEnclosureTag,pocketsTag,linerTag,fabricTextureTag,derivedDepartmentTag,collaborationsTag,itemTypeTag) {
function findValueInMultiValue(attrMV, valueToFind) {
    var existIndex = -1;
    var multiVal;
    var strval;
    if (valueToFind != null) {
        for (var i = 0; i < attrMV.getValues().size(); i++) {
            multiVal = attrMV.getValues().get(i);
            strval = multiVal.getSimpleValue();
            if (strval.equals(valueToFind)) {
                existIndex = i;
            }
        }
    }
...
while (selectedNodes.hasNext()) {
    ...
    if (activityTag != null) {
        ...
        tagArray.forEach(function (tagValID) {
            ...
            attrVal = selectNode.getValue(attributeID);
            ...
            if (lovValue != null) {
                var existIndex = findValueInMultiValue(attrVal, lovValue);
                if (existIndex >= 0) {
                    var multiVal = attrVal.getValues().get(existIndex);
                    multiVal.deleteCurrent();
                }
            }
        });
    }
    ...
    if (detailsFeaturesTag != null) {
        ...
        tagArray.forEach(function (tagValID) {
            attribute = "Details/Features Tag";
