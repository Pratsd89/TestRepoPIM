...
{
  "id" : "br_SEOLegacyURLGeneration_ENCA_Input",
  "type" : "BusinessAction",
  "setupGroups" : [ "SEO" ],
  "name" : "SEO Legacy URL Generation ENCA Input",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
fw.write("Brand,Market,Context,ObjectType,ID,CID,EN_CA_Name,EN_CA_ParentName,EN_CA_CategoryName,CategoryStartDate,CategoryEndDate,WebCategoryHide,EN_CA_NLU,EN_CA_LegayPreviewURL,EN_CA_NLUPreviewURL,EN_CA_Legay_LIVEURL,EN_CA_NLU_LIVEURL\n");
