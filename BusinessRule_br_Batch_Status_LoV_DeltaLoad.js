...
{
  "id" : "br_Batch_Status_LoV_DeltaLoad",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Batch Status LoV DeltaLoad",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ "Batch" ],
...
var batchID = node.getValue("a_Batch_Identifier").getSimpleValue();
var batchStatus = node.getValue("a_Batch_Status").getSimpleValue();
