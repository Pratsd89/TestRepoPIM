...
{
  "id" : "Test_triggerTranslation",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "TEST Trigger Translation Complete",
  "description" : null,
  "scope" : "Global",
...
if (objectType == 'Style') {
    ...
    var inheritUSCopy = node.getValue("a_Inherit_US_Copy_Option").getSimpleValue();
    if (inheritUSCopy != null) {
