...
{
  "id" : "CreateStyletoSizeModelRef",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "CreateStyletoSizeModelRef",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
*/
exports.operation0 = function (node,step,log,sizeModelRef,sizeCodeRef,sizeModelRoot,portal,LKT,helper) {
// Get the selected new size model
var newSizeModel = portal.getSelectedSetOfNodes().iterator().next();
...
if (matchsc != skuCount) {
    portal.showAlert("ERROR", "Change of size model not permitted", "Matching Size Codes not found in the new Web Size Model, change not executed");
} else {
