...
{
  "id" : "MultiVariantGroup_Integrator",
  "type" : "BusinessFunction",
  "setupGroups" : [ "Functions" ],
  "name" : "MultiVariantGroupScreen",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
var Url = "https://stibo-ui.aks.stage.azeus.gaptech.com/groups/multi-variant-merge/create-variant-group?brand="+brand+"&context="+context+"&groupId="+nodeID;
