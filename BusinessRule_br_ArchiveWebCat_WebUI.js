...
{
  "id" : "br_ArchiveWebCat_WebUI",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "br_ArchiveWebCat_WebUI",
  "description" : null,
  "scope" : "Global",
...
//get current date br_ArchiveWebCat_WebUI
	...
	if (type == "WebCategory" || type == "WebSubCategory" || type == "WebDivision") {
		...
		if (parentType == "WebBU") {
			...
			if (checkCat == archiveCat) {
				...
				// add this one so that it wont cause any issue 
