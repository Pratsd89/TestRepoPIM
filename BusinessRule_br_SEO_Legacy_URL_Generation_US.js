...
{
  "id" : "br_SEO_Legacy_URL_Generation_US",
  "type" : "BusinessAction",
  "setupGroups" : [ "SEO" ],
  "name" : "SEO Legacy URL Generation US",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
fw.write("Brand,Market,ObjectType,ID,CID,EN_US_NLU,EN_US_LegayPreviewURL,EN_US_NLUPreviewURL\n");
...
function generatePreviewNLULegacyURLUSDivision2(brandInput, nluInput, cidInput, legacy) {
...
function getDivisionDetails(divisiondObj, divContext) { //Division ID
    ...
    fw.write(brandNo + ","+market+","+objectTypeName + "," + divisionId + "," + divisionCID + "," + categoryNLU + "," + legacyPreview + "," + nluPreview + "\n");
...
function getCategoryDetails(ctyObject, ctyContext) {
    ...
    var legacyPreview = generatePreviewNLULegacyURLCategory(catBrandNo, ctyNLU, ctyCID, "LEGACY");
     var market = "US";
    fw.write(catBrandNo + ","+market+","+objectTypeCty + "," + ctyId + "," + ctyCID + "," + ctyNLU + "," + legacyPreview + "," + nluPreview + "\n");
...
function getSubCategoryDetails(subCtyObject, subCtyContext) {
    ...
    fw.write(subCtyBrandNo + ","+market+","+objectTypeSubCty + "," + subCtyid + "," + subCtyCID + "," + subCtyNLU + "," + legacyPreview + "," + nluPreview + "\n");
...
var emailBody = mailMethod.plainMessage("Please find NLU Preview URL's for US ");
// set attachment 
