...
{
  "id" : "br_bulk_Shot_Request_Import_Actions",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Bulk Shot Request Import Actions",
...
*/
exports.operation0 = function (step,node,ccAttr,REF_TYPE,LKT,eventType,assethubqueueUS,assethubqueueCA,assethubqueueJP,assethubqueueSA,importChanges,helper,photoLib) {
/*
    ...
    sharedMarkets.forEach(function (mkt) {
       ...
       // log.info(mkt.getValue())
        step.executeInContext(Context, function (otherContextManager) {
            ...
            if (found && changedAttrs.contains("a_Site_Placement") == false) {
            ...
            if (found || changedAttrs.contains("a_Site_Placement") == true) {
